...
def check_space(i,inlist,count):
    ...
    if(len(i.split())-1==c):
        ...
        return False
q = 0
dicinst = {"add":['10000','A'],"sub":['10001','A'],"addf":["00000",'A'],"subf":["00001",'A'],"mov":['10010','B'],"movf":["00010",'B'],"mov":['10011','C'],"ld":['10100','D'],
